...
if ((isset($_GET['title'])) and (isset($_GET['season']))){
    ...
    $sql = "DELETE FROM `intro` WHERE `TITLE` = '".mysql_real_escape_string($_GET['title'])."' AND `SEASON` = '".$_GET['season']."'";
    ...
    echo '<p><H2>Delete All Episodes Of Season Inside SkipDB</h2></p>';
